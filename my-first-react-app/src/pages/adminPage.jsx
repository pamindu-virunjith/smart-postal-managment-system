    ...
    return (
        <div className='w-full h-screen flex bg-gray-100 p-2'>
            <div className='h-full w-[300px] bg-red-200 rounded-xl shadow-lg p-4 flex flex-col mr-2'>
                <Link to ="/admin/users" className=" p-2 flex items-center text-xl hover:bg-red-300 rounded-xl" > <FaUsers className="mr-2 text-blue-700"/> Users</Link>
                <Link to ="/admin/parcel" className=" p-2 flex items-center text-xl hover:bg-red-300 rounded-xl"> <MdOutlineWarehouse className="mr-2 text-amber-950"/> Parcel</Link>
                <Link to ="/admin/orders" className=" p-2 flex items-center text-xl hover:bg-red-300 rounded-xl"> <LiaFileInvoiceSolid className="mr-2 text-rose-600"/> Orders</Link>
            </div>
