    ...
    return(
        <div className='w-full min-h-screen flex flex-col lg:flex-row relative overflow-hidden'>
            ...
            <div className='w-full lg:w-1/2 flex justify-center items-center relative z-10 px-4 py-6 lg:py-0 lg:px-0'>
                <div className="w-full max-w-[450px] backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl rounded-2xl flex flex-col justify-center items-center p-4 lg:p-8 relative">
                    
                    {/* Loading Overlay */}
                    {showSpinner && (
                        <div className="absolute inset-0 bg-black/50 backdrop-blur-sm rounded-2xl flex items-center justify-center z-50">
                            <div className="text-center">
                                <VscLoading className="text-white text-4xl lg:text-6xl animate-spin mx-auto mb-2 lg:mb-4" />
                                <p className="text-white text-base lg:text-lg">Signing you in...</p>
                            </div>
                        </div>
                    )}

                    <div className="w-full text-center mb-6 lg:mb-8">
                        <h1 className='text-3xl lg:text-5xl font-bold text-white mb-1 lg:mb-2'>Login</h1>
                        <p className="text-white/80 text-sm lg:text-lg">Welcome back! Please sign in to continue</p>
                    </div>              
                    
                    <div className="w-full space-y-3 lg:space-y-4 mb-4 lg:mb-6 px-4 lg:px-0">
                        <input 
                            onChange={(e) => setEmail(e.target.value)}
                            type="text"
                            value={email}
                            placeholder='Email' 
                            className='w-full h-10 lg:h-14 px-3 lg:px-4 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg lg:rounded-xl text-sm lg:text-base text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all duration-300'
                        />
                        <input 
                    ...
                    <div className="w-full space-y-3 lg:space-y-4">
                        <button 
                            onClick={handleClick}
                            className='w-full h-10 lg:h-14 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white text-sm lg:text-base font-semibold rounded-lg lg:rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg'
                        >
                            Sign In
                        </button>
                        ...
                        <button 
                            ...
                            className='w-full h-10 lg:h-14 bg-white/20 backdrop-blur-sm border border-white/30 hover:bg-white/30 text-white text-sm lg:text-base font-semibold rounded-lg lg:rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3'
                        >
                    ...
                    <div className='text-center mt-6 lg:mt-8'>
                        <p className='text-white/90 text-xs lg:text-base'>
